...
export async function Opice() {
  ...
  return (
      <div className="col-md-6">
        <div className="border-start border-3 border-primary ps-3 mb-4" style={{background: 'rgba(13,110,253,0.06)', borderRadius: '0 6px 6px 0', padding: '10px 10px 10px 12px'}}>
